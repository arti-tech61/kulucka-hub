...
export const IZMIRMANLIFTKIRALAMA_NET: Record<string, BespokeIcerik> = {
    ...
    "hizmet:manlift-kiralama": {
        h1: "Manlift Kiralama: Rafineri ve Liman Sahasında Doğru Erişim Sınıfını Seçmek",
        giris:
            "\"Manlift\" sahada tek bir makine tipini değil, insanı yükseğe taşıyan bütün personel platformlarını kapsayan bir şemsiye terimdir; makaslı platform, eklemli/teleskopik bomlu platform ve daha dar geçitler için tırmanan tip platformlar bu başlık altında anılır. Rafineri ve liman gibi ağır sanayi sahalarında bu genel adlandırma teklif aşamasında karışıklığa yol açabilir: talep sahibi \"manlift lazım\" dediğinde kastettiği çoğu zaman belirli bir yükseklik ve erişim biçimidir, fakat hangi alt sınıfın işe uyduğu ayrıca değerlendirilmelidir. Biz bu sayfada terimi daraltmak yerine doğru soruları sorarak açarız: çalışma noktası düz bir yüzeyin üzerinde mi yoksa boru hattı, tank gövdesi veya çelik konstrüksiyon gibi yatay uzanım gerektiren bir hedef mi, zemin beton mu yoksa rıhtım/dolgu mu, sahada ATEX bölgesi tanımlı mı. Manlift kiralama talebini iş izni ve operatör belgesi zincirinden ayrı düşünmeyiz; İzmir/Aliağa rafineri ve liman sahalarında makine seçimi ile giriş evrakı aynı hazırlık dosyasında birlikte ilerler. Bu sayfa, hangi alt sınıfın ne zaman doğru olduğunu ve seçim sonrası hangi izin adımlarının beklediğini anlatır.",
        maddeler: [
            { baslik: "Manlift şemsiye terimi altındaki alt sınıflar", metin: "Makaslı platform yalnız dikey hareket eder ve geniş bir çalışma alanı sunar; malzeme ile birden fazla kişiyi aynı anda taşımak için uygundur ama sepeti yana doğru uzatamaz. Eklemli veya teleskopik bomlu platform, engel üzerinden geçerek ya da yatayda uzanarak hedefe ulaşabilir; boru köprüsü, tank gövdesi veya çatı altı gibi düz erişimin yetmediği noktalarda tercih edilir. Dar koridor ve merdiven boşluğu gibi alanlarda ise küçük tırmanan tip platformlar değerlendirilir. \"Manlift kiralama\" talebi geldiğinde önce bu üç ailesinden hangisinin işe uyduğunu netleştiririz; isim benzerliği makine seçimini otomatik yapmaz." },
            { baslik: "Sınıf seçiminde belirleyici saha verileri", metin: "Doğru sınıfı belirleyen üç veri vardır: hedefin yüksekliği ve düşey/yatay konumu, zemin taşıma kapasitesi ve çalışma noktasının etrafındaki engeller. Rafineri sahasında boru rafı altında çalışma genelde yatay erişim ister, bu da bomlu platformu öne çıkarır. Liman rıhtımında düz bir depo cephesinde yapılan iş ise makaslı platformla daha ekonomik biçimde tamamlanabilir. Bu veriler telefonla kabaca alınmaz; keşif fotoğrafı, ölçü ve mümkünse zemin bilgisiyle birlikte değerlendirilir, çünkü yanlış sınıfla sahaya giden makine geri dönebilir." },
            { baslik: "Rafineri ve liman girişinde ortak evrak zinciri", metin: "Sınıf ne olursa olsun, ağır sanayi sahasına giren her manlift aynı temel evrak zincirinden geçer: makinenin periyodik kontrol raporu, operatörün yeterlilik ve sağlık kaydı, işin tanımlandığı çalışma izni ve varsa sıcak iş veya kapalı alan gibi ek izinler. Bu zincir alt sınıftan bağımsızdır; fakat makinenin boyutu ve ağırlığı giriş kapısı, asansör veya rıhtım taşıma sınırını etkileyebileceği için sınıf seçimi evrak hazırlığından önce netleşmelidir. Manlift kiralama sürecimizde makine ile evrak paralel ilerler; biri diğerini geciktirmez." },
            { baslik: "Elektrikli ve dizel tahrik arasında saha bağlamlı tercih", metin: "Kapalı üretim binası veya tank içi gibi havalandırması sınırlı alanlarda dizel tahrikli makine egzoz gazı nedeniyle tercih edilmez; elektrikli veya akülü seçenek öne çıkar. Açık liman sahasında uzun mesafe hareket ve düzensiz zemin gerektiren işlerde ise dizel veya arazi tipi tahrik daha uygun olabilir. ATEX bölgesi tanımlı bir noktada çalışma isteniyorsa bu bilgi keşif aşamasında paylaşılmalıdır; bölgeye uygun sertifikalı ekipman ihtiyacı ayrıca değerlendirilir ve tedarik süresi buna göre planlanır." },
            { baslik: "Yanlış terimle gelen talebi doğru sınıfa yönlendirmek", metin: "\"Manlift\" kelimesi sahada bazen yalnız bomlu platformu, bazen de genel anlamda bütün personel platformlarını tarif etmek için kullanılır. Bu yüzden teklif öncesi kısa bir doğrulama yaparız: hedefin fotoğrafı veya krokisi istenir, gerekiyorsa telefonda ölçü teyit edilir. Amaç terminolojiyi düzeltmek değil, sahaya yanlış sınıf makinenin gitmesini ve giriş kapısında geri çevrilmesini önlemektir. Bu ön doğrulama adımı, özellikle ilk kez çalıştığımız tesislerde teklif süresini kısaltır." },
        ],
        ekBolumler: [
            { baslik: "Manlift alt sınıflarının karşılaştırması", paragraflar: ["Aşağıdaki tablo, üç ana alt sınıfın hangi saha koşulunda öne çıktığını genel hatlarıyla özetler. Kesin makine ve model seçimi her zaman keşif verisiyle netleştirilir."], tablo: { basliklar: ["Alt sınıf", "Hareket biçimi", "Güçlü olduğu iş", "Zemin beklentisi"], satirlar: [["Makaslı platform", "Yalnız dikey", "Geniş, düz yüzey üstü çalışma, malzeme taşıma", "Düz, sağlam beton/asfalt"], ["Eklemli/teleskopik bomlu", "Dikey + yatay uzanım", "Engel üzerinden veya yana erişim gerektiren hedef", "Değişken, arazi tipi mevcut"], ["Tırmanan/dar tip platform", "Dikey, dar alanda", "Koridor, merdiven boşluğu, dar geçit", "Sabit iç mekân zemini"]] } },
            { baslik: "Doğru sınıfı belirleme adımları", paragraflar: ["Talep alındığında önce hedefin ne olduğu sorulur: boru hattı, tank gövdesi, çelik konstrüksiyon, raf sistemi veya düz cephe gibi. Ardından yükseklik ile yatay uzaklık ayrı ayrı ölçülür; sepetin hedefe hangi yönden yaklaşacağı krokiyle netleştirilir. Zemin tipi ve taşıma kapasitesi belli değilse bu bilgi keşifte tamamlanır.", "Bu adımlar tamamlanmadan teklif verilmez, çünkü yanlış sınıfla çıkarılan bir teklif sahada makinenin işe yaramamasına ve sevkiyatın tekrarlanmasına yol açar. Doğru sınıf belirlendikten sonra iş izni ve operatör planlaması bu karara göre şekillenir." ] },
            { baslik: "Rafineri ve liman özelinde manlift kullanımının farkı", paragraflar: ["Rafineri sahasında manlift çoğunlukla boru rafı, tank çevresi veya işletme içi çelik yapı etrafında çalışır; bu ortamda enerji izolasyonu, sıcak iş ayrımı ve ATEX bölge tanımı makine seçimini doğrudan etkiler. Liman sahasında ise rıhtım yükü, deniz kenarı rüzgâr etkisi ve sürekli araç trafiği öne çıkan koşullardır; makine boyutu ve tahrik tipi bu ortama göre değerlendirilir.", "İki ortam da genel \"manlift kiralama\" başlığı altında görünse de saha koşulları farklı önlemler gerektirir. Bu nedenle her talepte hangi ortamda çalışılacağı netleştirilir ve makine ile izin planı o ortama göre kurulur." ] },
        ],
        sss: [
            { soru: "Manlift dediğimizde hangi makine geliyor, biz de karar veriyor muyuz?", cevap: "Hayır, terim genel olduğu için önce hedefi ve saha koşulunu birlikte netleştiririz. Fotoğraf, ölçü veya kroki paylaşıldığında hangi alt sınıfın (makaslı, bomlu veya dar tip) işe uyduğunu biz öneririz; siz de bunu saha bilginizle teyit edersiniz. Karar tek taraflı verilmez, çünkü yanlış sınıfla gelen makine sahada işe yaramayabilir ve sevkiyat tekrarlanmak zorunda kalır." },
            { soru: "Rafineri sahasında hangi tahrik tipi tercih edilmeli?", cevap: "Kapalı veya havalandırması sınırlı alanlarda elektrikli ya da akülü tahrik öne çıkar; egzoz gazı birikimi riski taşımaz. Açık sahada uzun mesafe hareket gerekiyorsa dizel veya arazi tipi tahrik değerlendirilebilir. ATEX bölgesi tanımlıysa bu bilgi keşifte paylaşılmalı; bölgeye uygun sertifikalı ekipman ihtiyacı ayrıca değerlendirilir ve bu durum tedarik süresini etkileyebilir." },
            { soru: "Liman rıhtımında manlift kullanırken ek bir önlem gerekir mi?", cevap: "Evet, rıhtım kenarına yaklaşma mesafesi, zemin taşıma kapasitesi ve deniz kenarı rüzgâr etkisi ayrıca değerlendirilir. Kenara çok yakın çalışma devrilme riski taşıyabileceği için üreticinin eğim ve kenar mesafesi kuralları uygulanır. Rüzgâr hızı üretici sınırını aşarsa çalışma ertelenir; bu karar operatörün göz kararıyla değil ölçülebilir veriyle verilir." },
            { soru: "Yanlış sınıf makine talep edersek ne olur?", cevap: "Sahaya gitmeden önce doğrulama adımımız bunu büyük ölçüde önler; yine de saha koşulu tarif edilenden farklı çıkarsa keşif veya sevkiyat sırasında fark edilir. Mümkünse aynı gün doğru sınıfa geçiş yapılır, mümkün değilse yeni sevkiyat planlanır. Bu tür bir gecikmeyi önlemek için ilk talepte hedefin fotoğrafını veya krokisini paylaşmanızı öneririz." },
            { soru: "Operatörlü mi yoksa yalnız makine kiralama mı seçmeliyiz?", cevap: "Bu karar sahanın izin karmaşıklığına ve kullanacak personelin belgesine bağlıdır. Rafineri ve liman gibi çok adımlı iş izni gerektiren sahalarda operatörlü hizmet, personel dosyası ile vardiya devri sorumluluğunu daha belirgin tuttuğu için sıklıkla tercih edilir. Kendi belgeli operatörünüz varsa ve tesis prosedürü uygunsa yalnız makine kiralama da değerlendirilebilir; bu durumda yeterlilik kayıtları önceden görülür." },
            { soru: "Manlift kiralama süresi hangi verilere göre belirlenir?", cevap: "Süre, işin kapsamı, iş izninin geçerlilik penceresi ve sahaya erişim koşullarına göre belirlenir. Rafineri veya liman gibi çok adımlı izin gerektiren sahalarda evrak onay süresi de programa dahil edilir; makine iş bitmeden erken çekilmez, iş uzarsa sözleşmedeki uzatma koşulları uygulanır. Bu koşullar teklif aşamasında yazılı paylaşılır, sahada belirsizlik bırakılmaz." },
        ],
        kaynak: "Elle yazıldı — 2026-08-14. Manlift alt sınıflarının genel tanımı (makaslı, bomlu, tırmanan tip) ve tahrik tipi seçim mantığı sektörde bilinen genel bilgidir; rafineri/liman saha uygulaması ve izin süreci firma pratiğidir. Model, tesis adı veya doğrulanmamış rakam kullanılmamıştır.",
    },
    "hizmet:makasli-platform-kiralama": {
        h1: "Makaslı Platform Kiralama: Rafineri ve Liman Sahasında Sabit Dikey Erişim",
        giris:
            "Makaslı platform, adını çalışma prensibinden alır: makas mekanizması sepeti yalnızca dikey doğrultuda yükseltir, yana doğru uzanma imkânı yoktur. Bu sınırlama bir eksiklik değil, doğru işte belirgin bir avantaza dönüşür — geniş platform alanı sayesinde birden fazla kişi ve malzeme aynı anda yukarı taşınabilir, bu da boru hattı üstü yalıtım işi, tank gövdesi boyama hazırlığı veya çatı altı kablo döşemesi gibi düz yüzey üzerinde uzun süre çalışılan işlerde eklemli platforma göre daha verimli sonuç verir. İzmir/Aliağa rafineri ve liman sahalarında makaslı platform talebi genellikle sabit, önceden bilinen bir çalışma noktası için gelir: hedef yatayda kaymıyor, zemin beton veya asfalt, iş birden fazla vardiyaya yayılabiliyor. Bu profil, makinenin zemin taşıma gereksinimini ve tahrik tipini de belirler — ağır sanayi zemininde tekerlek izi bırakmayan, kapalı alanda kullanılabilen elektrikli seçenekler öne çıkar. Bu sayfada makaslı platformun hangi işte doğru seçim olduğunu, hangi işte olmadığını ve rafineri/liman girişinde bu sınıfa özgü hangi kontrollerin yapıldığını anlatıyoruz.",
        maddeler: [
            { baslik: "Yalnızca dikey hareketin avantaj olduğu işler", metin: "Sepet yana uzanamadığı için makaslı platform, hedefin tam altına veya önüne konumlanabildiği işlerde en verimli sonucu verir: düz bir tank cephesi, boru rafı altında düz bir hat, depo cephesindeki raf sistemi veya çatı altı aydınlatma gibi. Hedef engelli bir geometri gerektiriyorsa, örneğin boru köprüsünün arkasına veya bir ekipmanın yan tarafına ulaşmak gerekiyorsa, makaslı platform yetersiz kalır ve bomlu platform değerlendirilir. Talep alındığında hedefin geometrisini netleştirmek, doğru sınıfı belirlemenin ilk adımıdır." },
            { baslik: "Geniş platform alanının getirdiği pratik fayda", metin: "Makaslı platformun sepeti, bomlu platforma göre genellikle daha büyük bir çalışma alanı sunar; bu, aynı anda birden fazla kişinin ve malzemenin (boru parçası, izolasyon malzemesi, el aleti) yukarı taşınmasına imkân verir. Sürekli malzeme indirip kaldırmak yerine tek seferde gerekli ekipmanla çıkmak, özellikle uzun süren rafineri bakım işlerinde zaman kazandırır. Bu avantaj, işin yatay hareket gerektirmediği ölçüde geçerlidir; iş noktadan noktaya kayıyorsa platformun kendini sık sık taşıması gerekir ve bu durumda avantaj azalır." },
            { baslik: "Zemin taşıma kapasitesi ve ağırlık dağılımı", metin: "Makaslı platformun teker izi noktasal ağırlık taşır; rafineri sahasındaki beton zemin çoğunlukla bu yükü karşılar, fakat liman rıhtımında dolgu alan veya eski kaplama varsa zeminin taşıma kapasitesi önceden sorgulanır. Ağır tonajlı elektrikli modellerde bu kontrol özellikle önemlidir. Zemin bilgisi belirsizse yük dağıtıcı plaka kullanımı veya daha hafif sınıf makine değerlendirilir; sepet yükseltilmeden önce zeminin görsel kontrolü de operatör tarafından yapılır." },
            { baslik: "Elektrikli tahrik ve kapalı alan uygunluğu", metin: "Rafineri içi kapalı ünitelerde veya tank içi gibi havalandırması sınırlı noktalarda dizel tahrikli makine egzoz birikimi nedeniyle tercih edilmez; makaslı platformların elektrikli/akülü seçenekleri bu ortamlarda daha uygundur. ATEX bölgesi tanımlı bir noktada çalışma isteniyorsa bu bilgi keşifte paylaşılmalıdır; bölgeye uygun sertifikalı ekipman ihtiyacı ayrıca değerlendirilir. Açık liman sahasında ise dış mekân koşullarına uygun model tercih edilir; her iki durumda da tahrik tipi seçimi işin ortamına göre yapılır, otomatik varsayılmaz." },
            { baslik: "Makaslı platformun yetersiz kaldığı durumları önceden ayırmak", metin: "Talep geldiğinde hedefin yatay erişim gerektirip gerektirmediği, sepetin bir engelin üzerinden geçmesi gerekip gerekmediği ve zeminin düzgünlüğü sorgulanır. Bu sorulardan biri bile olumsuz yanıtlanırsa makaslı platform yerine eklemli/bomlu platform önerilir. Amaç her talebe aynı makineyi önermek değil, sahaya giden makinenin işi gerçekten yapabilmesini sağlamaktır; yanlış sınıfla çıkan bir sevkiyat sahada geri dönebilir." },
        ],
        ekBolumler: [
            { baslik: "Makaslı platform ile bomlu platform karşılaştırması", paragraflar: ["Aşağıdaki tablo, iki ana sınıfın hangi iş profilinde öne çıktığını özetler; kesin seçim keşif verisiyle netleştirilir."], tablo: { basliklar: ["Özellik", "Makaslı platform", "Bomlu (eklemli/teleskopik)"], satirlar: [["Hareket yönü", "Yalnız dikey", "Dikey + yatay uzanım"], ["Platform alanı", "Geniş, çok kişi/malzeme", "Daha dar, tek nokta erişim"], ["Engel üzerinden erişim", "Uygun değil", "Uygun"], ["Zemin beklentisi", "Düz, sağlam beton/asfalt", "Değişken, arazi tipi seçenek mevcut"], ["Tipik rafineri işi", "Tank cephesi, düz boru hattı üstü", "Boru köprüsü arkası, ekipman yan yüzeyi"]] } },
            { baslik: "Doğru makas sınıfını belirleme süreci", paragraflar: ["Talep alındığında önce hedefin fotoğrafı veya krokisi istenir; yükseklik, zemin tipi ve sepetin hedefe hangi yönden yaklaşacağı birlikte değerlendirilir. Kapalı alanda mı açık sahada mı çalışılacağı, ATEX bölgesi olup olmadığı ve iş süresinin kaç vardiyaya yayılacağı da bu aşamada sorulur.", "Bu bilgiler netleşmeden teklif verilmez; çünkü makaslı platformun avantajı ancak doğru iş profilinde ortaya çıkar. Yanlış profile önerilen bir makaslı platform, sahada eksik erişim nedeniyle işi tamamlayamaz ve sınıf değişikliği gerektirebilir." ] },
            { baslik: "Rafineri ve liman girişinde makaslı platforma özgü kontroller", paragraflar: ["Genel iş izni ve operatör evrakı zincirine ek olarak, makaslı platformun ağırlığı ve teker izi nedeniyle zemin taşıma onayı ayrıca istenebilir; özellikle rıhtım veya yeni dolgu alanlarda bu kontrol atlanmaz. Elektrikli modelde şarj alanının elektrik ve havalandırma koşulu da giriş öncesi değerlendirilir.", "ATEX bölgesi tanımlı bir noktada çalışma isteniyorsa bölgeye uygun sertifikalı ekipman ihtiyacı giriş dosyasına eklenir ve bu durum tedarik süresini etkileyebilir. Bu kontroller, makaslı platformun genel manlift izin zincirine eklediği sınıfa özgü ek adımlardır." ] },
        ],
        sss: [
            { soru: "Makaslı platform hangi işte bomlu platforma göre daha avantajlı?", cevap: "Hedef sabit ve düz bir yüzeyse, iş yatay kayma gerektirmiyorsa ve birden fazla kişi veya malzeme aynı anda yukarı taşınacaksa makaslı platform genellikle daha verimlidir. Geniş platform alanı sayesinde malzeme indirip kaldırma sıklığı azalır. İş boru köprüsü arkası gibi engelli bir geometri gerektiriyorsa bu avantaj geçerli değildir, o durumda bomlu platform önerilir." },
            { soru: "Rıhtımda makaslı platform kullanılabilir mi?", cevap: "Zeminin taşıma kapasitesi ve düzgünlüğü uygunsa kullanılabilir; ancak dolgu alan, eski kaplama veya eğimli kenar varsa önce zemin değerlendirmesi yapılır. Kenara çok yakın çalışma devrilme riski taşıyabileceği için üreticinin kenar mesafesi kuralı uygulanır. Zemin belirsizse yük dağıtıcı plaka veya farklı sınıf makine değerlendirilir; göz kararıyla karar verilmez." },
            { soru: "ATEX bölgesinde makaslı platform kullanılıyor mu?", cevap: "Bölgeye uygun sertifikalı ekipman ihtiyacı ayrıca değerlendirilir; standart elektrikli veya dizel model her ATEX bölgesinde kullanılamayabilir. Bu bilgi keşif veya talep aşamasında paylaşılmalıdır, çünkü uygun sertifikalı ekipmanın tedarik süresi standart makineden farklı olabilir. Bölge sınıfı netleşmeden sevkiyat planlanmaz." },
            { soru: "Makaslı platformun taşıyabileceği kişi ve malzeme sınırı nasıl belirlenir?", cevap: "Sınır, kiralanan modelin üretici tarafından belirlenmiş platform kapasitesine göredir; kişi sayısı ile taşınan malzemenin toplam ağırlığı bu kapasiteyi aşmamalıdır. İş tanımı netleştiğinde kaç kişi ve ne tür malzemenin taşınacağı sorulur, buna uygun kapasitede model önerilir. Kapasite aşımı operatör tarafından kabul edilmez; bu güvenlik sınırı sahada esnetilmez." },
            { soru: "Kapalı rafineri ünitesinde hangi tahrik tipi kullanılmalı?", cevap: "Havalandırması sınırlı kapalı alanlarda dizel tahrik egzoz birikimi riski taşıdığı için tercih edilmez; elektrikli veya akülü model önerilir. Şarj alanının elektrik ve havalandırma koşulu uygun olmalı, kablo yaya veya makine güzergâhından geçirilmemelidir. Açık sahada uzun mesafe hareket gerekiyorsa farklı tahrik seçenekleri de değerlendirilebilir." },
            { soru: "Makaslı platform ile bomlu platform arasında kararsız kalırsak ne yaparsınız?", cevap: "Hedefin fotoğrafı veya krokisini isteriz; yatay erişim gerekip gerekmediğini, zemin tipini ve iş süresini birlikte değerlendirip size somut bir öneri sunarız. Kararsızlık durumunda genellikle daha esnek olan bomlu platform güvenli tarafta kalır, fakat maliyet ve platform alanı önemliyse ve iş profili uygunsa makaslı platform önerilir. Nihai karar her zaman saha verisine dayanır." },
        ],
        kaynak: "Elle yazıldı — 2026-08-14. Makaslı platformun çalışma prensibi (yalnız dikey hareket, geniş platform alanı) sektörde bilinen genel bilgidir; rafineri/liman saha uygulaması, zemin ve ATEX değerlendirmesi firma pratiğidir. Model, tesis adı veya doğrulanmamış rakam kullanılmamıştır.",
    },
};
