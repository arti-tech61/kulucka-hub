...
export const yazilar: Yazi[] = [
    ...
    },
    {
        ...
        ozet: "Gemi söküm tesislerinin yanı sıra Aliağa, Türkiye'nin hurda ve çelik geri dönüşüm kapasitesinin de önemli bir merkezi. Bölgenin bu daha az bilinen sanayi katmanına bakış.",
        tarih: "2026-07-20",
        paragraflar: [
            "Aliağa denince akla ilk gelen petrokimya ve gemi söküm olsa da, bölge aynı zamanda Türkiye'nin en büyük hurda çelik işleme ve elektrik ark ocaklı üretim kapasitelerinden bazılarına ev sahipliği yapıyor.",
            "Gemi söküm tesislerinden çıkan çelik hurda, doğrudan yakındaki eritme tesislerine taşınarak bölgesel bir döngüsel ekonomi oluşturuyor — bu da nakliye ve ağır kaldırma ekipmanı talebini kesintisiz kılıyor.",
            "Bu sanayi kolunda çalışma koşulları özellikle zorlu: yüksek sıcaklık, ağır malzeme taşıma ve kesintisiz vardiya düzeni, ekipman dayanıklılığı ve operatör güvenliği konusunda standart üstü önlem gerektiriyor.",
            "İzmir Sektör, Aliağa'nın metal geri dönüşüm kapasitesindeki genişleme haberlerini ve bunun bölge istihdamına etkisini izlemeye devam edecek.",
        ],
    },
    {
