...
export const siteler: SiteIcerik[] = [
    ...
    },
    {
        ...
        paragraflar: [
            "Kütahya ve ilçelerindeki seramik fabrikaları, depo raf sistemleri, cam ve çini atölyeleri ile kamu binalarının bakım işleri için makaslı veya bomlu platform sınıfı değerlendirilebilir. Uygun çalışma yüksekliği güncel makine bilgileri ve saha koşullarıyla doğrulanır.",
        ...
        hizmetler: ["Elektrikli ve dizel makaslı platform değerlendirmesi", "Bomlu platform sınıfı değerlendirmesi", "Fabrika içi hassas zemin planı", "Proje süresine göre teklif", "Stok ve rotaya göre sevkiyat planlaması"],
    ...
    },
    {
        ...
        paragraflar: [
            "Aydın merkez, Efeler, Nazilli, Söke ve Kuşadası hattındaki jeotermal enerji tesisleri, zeytin ve incir işleme sanayii, oteller ve inşaat projeleri için makaslı veya bomlu platform sınıfı saha bilgilerine göre değerlendirilir.",
        ...
        hizmetler: ["Elektrikli ve dizel makaslı platform değerlendirmesi", "Bomlu platform sınıfı değerlendirmesi", "Otel ve tesis bakımlarına dönemsel teklif", "Tarım sanayii depo çalışmaları", "Stok ve rotaya göre sevkiyat planlaması"],
        anaSite: { ad: "Artı Platform", url: "https://www.artiplatform.com.tr" },
    ...
    },
    {
        ...
        hizmetler: ["Makaslı platform sınıfı değerlendirmesi", "Bomlu platform sınıfı değerlendirmesi", "Enerji santrali bakım planı", "Proje bazlı sahada konuşlu kiralama teklifi", "Operatör yeterliliği ve uygunluk kontrolü"],
        anaSite: { ad: "Artı Platform", url: "https://www.artiplatform.com.tr" },
    ...
    },
    {
        ...
        paragraflar: [
            "Manisa Organize Sanayi Bölgesi, Turgutlu, Salihli ve Akhisar hattındaki elektronik fabrikaları, gıda işleme tesisleri ve lojistik depoların yüksekte çalışma ihtiyaçları için makaslı veya bomlu platform sınıfı değerlendirilir.",
